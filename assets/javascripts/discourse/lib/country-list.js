export default [
  ...
  { id: "BRA", name: "Brazil" },
  { id: "IOT", name: "British Indian Ocean Territory (the)" },
  ...
  { id: "CAN", name: "Canada" },
  { id: "CYM", name: "Cayman Islands (the)" },
  { id: "CAF", name: "Central African Republic (the)" },
  { id: "TCD", name: "Chad" },
  { id: "CHL", name: "Chile" },
  { id: "CHN", name: "China" },
  { id: "CXR", name: "Christmas Island" },
  { id: "CCK", name: "Cocos (Keeling) Islands (the)" },
  { id: "COL", name: "Colombia" },
  { id: "COM", name: "Comoros (the)" },
  { id: "COD", name: "Congo (the Democratic Republic of the)" },
  { id: "COG", name: "Congo (the)" },
  { id: "COK", name: "Cook Islands (the)" },
  ...
  { id: "DOM", name: "Dominican Republic (the)" },
  { id: "ECU", name: "Ecuador" },
  { id: "EGY", name: "Egypt" },
  ...
  { id: "FLK", name: "Falkland Islands (the) [Malvinas]" },
  { id: "FRO", name: "Faroe Islands (the)" },
  { id: "FJI", name: "Fiji" },
  { id: "FIN", name: "Finland" },
  { id: "FRA", name: "France" },
  { id: "GUF", name: "French Guiana" },
  { id: "PYF", name: "French Polynesia" },
  { id: "ATF", name: "French Southern Territories (the)" },
  { id: "GAB", name: "Gabon" },
  ...
  { id: "PRK", name: "Korea (the Democratic People's Republic of)" },
  { id: "KOR", name: "Korea (the Republic of)" },
  { id: "KWT", name: "Kuwait" },
  { id: "KGZ", name: "Kyrgyzstan" },
  { id: "LAO", name: "Lao People's Democratic Republic (the)" },
  { id: "LVA", name: "Latvia" },
  { id: "LBN", name: "Lebanon" },
  { id: "LSO", name: "Lesotho" },
  { id: "LBR", name: "Liberia" },
  ...
  { id: "MLI", name: "Mali" },
  { id: "MLT", name: "Malta" },
  { id: "MHL", name: "Marshall Islands (the)" },
  ...
  { id: "MDA", name: "Moldova (the Republic of)" },
  { id: "MCO", name: "Monaco" },
  ...
  { id: "PER", name: "Peru" },
  { id: "PHL", name: "Philippines (the)" },
  { id: "PCN", name: "Pitcairn" },
  { id: "POL", name: "Poland" },
  { id: "PRT", name: "Portugal" },
  { id: "PRI", name: "Puerto Rico" },
  { id: "QAT", name: "Qatar" },
  { id: "MKD", name: "Republic of North Macedonia" },
  { id: "ROU", name: "Romania" },
  ...
  { id: "TCA", name: "Turks and Caicos Islands (the)" },
  { id: "TUV", name: "Tuvalu" },
  { id: "UGA", name: "Uganda" },
  { id: "UKR", name: "Ukraine" },
  { id: "ARE", name: "United Arab Emirates (the)" },
  {
    id: "GBR",
    name: "United Kingdom of Great Britain and Northern Ireland (the)",
  },
  { id: "UMI", name: "United States Minor Outlying Islands (the)" },
  { id: "USA", name: "United States of America (the)" },
  { id: "URY", name: "Uruguay" },
